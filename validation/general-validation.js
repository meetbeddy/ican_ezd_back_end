...
module.exports = {
    ...
    register: function(data) {
        ...
        data.tellerNumber = data.tellerNumber === undefined ? "" : data.tellerNumber;
        ...
        data.memberStatus = data.memberStatus === undefined ? "" : data.memberStatus;
        ...
        if (!Validator.isEmpty(data.memberStatus) && data.memberStatus.toLowerCase() === "member") {
